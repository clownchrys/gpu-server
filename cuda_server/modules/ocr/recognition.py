...
def recognizer_predict(
    model, converter, test_loader, batch_max_length,
...
def get_recognizer(
    ...
    if recog_network == 'generation1':
        model_pkg = importlib.import_module("modules.ocr.model.model")
    elif recog_network == 'generation2':
        model_pkg = importlib.import_module("modules.ocr.model.vgg_model")
    else:
...
def get_text(
    character, imgH, imgW, recognizer, converter, image_list,
